...
import { faUser, faArrowCircleRight, faDoorOpen, faHome, faChalkboardTeacher } from '@fortawesome/free-solid-svg-icons';
        ...
        <ul className="mt-6 text-xl mx-2">
          <li className="py-2 px-3 my-2 hover:bg-gray-400 rounded cursor-pointer">
            <a href="#" className="flex items-center">
              ...
              <span style={{fontFamily: "Segoe UI"}} className='mx-2 font-medium'>Dashboard</span>
            </a>
          </li>
          <li className="py-2 px-3 my-2 hover:bg-gray-400 rounded cursor-pointer">
            <a href="#" className="flex items-center">
              <FontAwesomeIcon icon={faUser} className="mr-2" />
              <span style={{fontFamily: "Segoe UI"}} className='mx-3 font-medium'>Siswa</span>
            </a>
          </li>
          <li className="py-2 px-3 my-2 hover:bg-gray-400 rounded cursor-pointer">
            <a href="#" className="flex items-center">
              <FontAwesomeIcon icon={faChalkboardTeacher} className="mr-2" />
              <span style={{fontFamily: "Segoe UI"}} className='mx-1 font-medium'>Guru</span>
            </a>
          </li>
          <li className="py-2 px-3 my-2 hover:bg-gray-400 rounded cursor-pointer">
            <a href="#" className="flex items-center">
              <FontAwesomeIcon icon={faDoorOpen} className="mr-2" />
              <span style={{fontFamily: "Segoe UI"}} className='mx-2 font-medium'>Kelas</span>
            </a>
          </li>
